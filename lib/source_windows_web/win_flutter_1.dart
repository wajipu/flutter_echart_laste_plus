...
import '../source_ios_android/echarts_script.dart' show echartsScript;
...
class EchartsWin extends StatefulWidget {
  EchartsWin(
      {Key? key,
  ...
  final void Function(WinWebViewController)? onLoad;

  final void Function(WinWebViewController, Exception)? onWebResourceError;
...
class _EchartsState extends State<EchartsWin> {
  ...
  void initState() {
    ...
    _controller = WinWebViewController()
      ..setBackgroundColor(Colors.white38)
  ...
  @override
  void didUpdateWidget(EchartsWin oldWidget) {
